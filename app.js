...
var Blogdetail = require('./models/Blogdetail')
...
mongoose.connect('mongodb://localhost/bubublog')
...
// 	}
// })
app.post('/detailsave', function(req, res) {
	var data = req.body;
	var blogdetail = new Blogdetail(data);
	blogdetail.save(function(err, blogdetail) {
		if (err) {
			console.log(err);
		}
		res.send({
...
app.get('/getdetail', function(req, res) {
	Blogdetail.find({}, function(err, blogdetail) {
		res.send({
			data: blogdetail
		})
	})
